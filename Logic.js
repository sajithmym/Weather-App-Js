let searchInp = document.querySelector('._search');
let city = document.querySelector('.city');
let day = document.querySelector('.day');
let humidity = document.querySelector('.indicate--Huminity>.value');
let wind = document.querySelector('.indicate--wind>.value');
let pressure = document.querySelector('.indicate--pressure>.value');
let image = document.querySelector('.image');
let temperature = document.querySelector('.showtemp>.value');
